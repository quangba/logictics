                    ...
                    <div class="mb-4">
                        @if (isset($config))
                            <p class="alert alert-info">
                                <strong>Thiết lập hiện tại:</strong> hệ thống sẽ xoá các Freight có <code>updated_at</code> là <strong>{{ $config->duration }} tháng</strong>.
                            </p>
                        @else
                            <p class="alert alert-warning">
                                <strong>Chưa thiết lập cấu hình xoá dữ liệu Freight.</strong> Vui lòng chọn thời gian bên dưới để hệ thống tự động xử lý.
                            </p>
                        @endif
                    </div>

                    <form action="{{ route('carrier.clean_config.update') }}" method="POST" class="d-flex flex-wrap align-items-end gap-4">
                        @csrf
                        ...
                        <div class="form-group mb-0 d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append align-content-center ml-2 mr-2">
                        ...
                        <button type="submit" class="btn btn-primary mt-5 mt-md-0">Lưu thiết lập</button>
                    </form>
