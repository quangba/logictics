...
@section('content')
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    @if (Auth::user()->id == SUPER_ADMIN_ID)
                        <a class="btn btn-sm btn-success btn-round mt--30 mb-5" href="{{ route('carrier.import') }}">
                            <i class="icon md-upload" aria-hidden="true"></i>
                            <span class="hidden-sm-down">Import Excel</span>
                        </a>
                    ...
                    @if (Auth::user()->id == SUPER_ADMIN_ID)
                        <div class="d-flex">
                            <button class="btn btn-danger mb-3 btn-round" id="deleteSelected"><i class="md-delete"
                                    aria-hidden="true"></i><span class="hidden-sm-down ml-5">Delete</span></button>
                        </div>
                    @endif
    ...
    @include('includes.modals.confirm_delete', [
        'message' => 'Bạn có chắc muốn xoá các Freight đã chọn không?',
    ])
@endsection()
